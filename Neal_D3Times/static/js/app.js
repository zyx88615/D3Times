...
function renderAxes1(newYScale, yAxis) {
  ...
  function updateToolTip(chosenXAxis, circlesGroup, chosenYAxis) {
    ...
    circlesGroup.on("mouseover", function(data) {
      ...
      coord=[[this.cx.baseVal.value+10,this.cy.baseVal.value],[650,50],[690,50]]
      ...
      .attr("cx", 690+(460-this.cy.baseVal.value)/10)
      .attr("cy", 50)
      ...
      .attr("y", 50)
      .attr("x", 690+(460-this.cy.baseVal.value)/10*2+10)
      ...
      chartGroup.append("text")
      .attr("y", 50+20)
      .attr("x", 690+(460-this.cy.baseVal.value)/10*2+50)
      ...
      chartGroup.append("text")
      .attr("y", 50+20)
      .attr("x", 690+(460-this.cy.baseVal.value)/10*2+30)
      .text(this.getAttribute('yvv')+"%")
      .attr("class", "sometext")
      .attr('text-anchor', 'middle')
      .attr('alignment-baseline', 'middle')
  ...
  d3.json("/data").then(function(liveData) {
